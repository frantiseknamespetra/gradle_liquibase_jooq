...
public class CountryRecord extends UpdatableRecordImpl<CountryRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = 77969997;

    /**
     * Setter for <code>messaging.country.id</code>.
     */
    public CountryRecord setId(Integer value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>messaging.country.id</code>.
     */
    ...
    /**
     * Setter for <code>messaging.country.name</code>.
     */
    ...
    /**
     * Getter for <code>messaging.country.name</code>.
     */
